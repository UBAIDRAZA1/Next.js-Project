    ...
    <div className="border-b-2 border bg-gray-200">
      ...
      <div className="md:px-56 hidden text-gray-200 md:flex justify-between items-center px-4 py-2 bg-[#272343]">
        ...
        <div className="flex items-center space-x-6 text-sm">
          <div>Eng</div>
          <Link href="/components/project12/faqs" className="hover:text-teal-600">FAQs</Link>
          <div className="flex items-center space-x-1">
            <IoIosHelpCircleOutline size={16} />
            <Link href="/components/project12/contact" className="hover:text-teal-600">Need Help</Link>
          </div>
        </div>
      </div>
      ...
      <div className="hidden md:px-56 md:flex bg-white px-4 py-5">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-6 font-thin text-gray-700">
            <Link href="/components/project12" className="hover:text-teal-600">Home</Link>
            <Link href="/components/project12/products" className="hover:text-teal-600">Shop</Link>
            <Link href="/components/project12/singleproduct" className="hover:text-teal-600">Product</Link>
            <Link href="/components/project12/cart" className="hover:text-teal-600">Pages</Link>
            <Link href="/components/project12/about" className="hover:text-teal-600">About</Link>
          </div>

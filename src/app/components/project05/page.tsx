...
export default function Home() {
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      {/* Hero Section */}
      <motion.section
        className="flex flex-col md:flex-row items-center md:items-start p-6 md:space-x-8"
      ...
      >
        ...
        <div className="bg-gray-900 p-6 rounded-xl space-y-10">
          ...
          <div className="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6">
            <div className="md:w-1/2 flex justify-center md:justify-start">
              <Image src="/image14.png" alt="Classic Watches" width={450} height={300} className="rounded-xl" />
            </div>
            <div className="md:w-1/2 space-y-4">
          ...
          {/* Perfumes & Earbuds Project */}
          <div className="flex flex-col md:flex-row-reverse space-y-6 md:space-y-0 md:space-x-6">
            <div className="md:w-1/2 flex justify-center md:justify-end">
              <Image src="/image15.png" alt="Perfume & Earbuds Collection" width={450} height={300} className="rounded-xl" />
            </div>
            <div className="md:w-1/2 space-y-4">
      ...
      >
        ...
        <form className="space-y-4">
          ...
          <button type="submit" className="bg-lime-500 px-6 py-2 rounded-full hover:bg-lime-400 transform transition duration-300 hover:scale-105">
            Send Message
          </button>
        </form>
      </motion.section>

      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-5">
       ...
       <div className="bg-stone-100 mt-12 flex flex-col items-center py-16">
           ...
           <div className="grid grid-cols-2 md:grid-cols-6 gap-6 px-6">
               <img src="/milestone2/sec1.png.png" alt="Product 1" className="w-32 h-32 object-cover rounded-md shadow-md" />
               <img src="/milestone2/sec.png.png" alt="Product 2" className="w-32 h-32 object-cover rounded-md shadow-md" />
               <img src="/milestone2/chair2.png" alt="Product 3" className="w-32 h-32 object-cover rounded-md shadow-md" />
               <img src="/milestone2/chair.png" alt="Product 4" className="w-32 h-32 object-cover rounded-md shadow-md" />
               <img src="/milestone2/chair3.png" alt="Product 5" className="w-32 h-32 object-cover rounded-md shadow-md" />
               <img src="/milestone2/sec2.png.png" alt="Product 6" className="w-32 h-32 object-cover rounded-md shadow-md" />
           </div>
       </div>
</div>
  );
